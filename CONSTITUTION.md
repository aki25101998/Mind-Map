...
1. **Luôn luôn cập nhật GitHub:** Mỗi khi hoàn thành một chức năng mới, sửa lỗi, hoặc có bất kỳ thay đổi nào về mã nguồn, bắt buộc phải thực hiện commit và push lên repository GitHub ngay lập tức.
